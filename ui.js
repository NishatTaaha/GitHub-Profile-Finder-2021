class UI{
    ...
    showProfile(user) {
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <a class="btn btn-success btn-block mb-4" href="${user.html_url}" target="_blank">View Profile</a>
            </div>
            <div class="col-md-9">
    ...
    <h3 class="page-heading mb-3" style="color: white;">Latest Repositories</h3>
    <div id="repos"></div>
        `;
    }
    ...
    showRepos(repos){
        ...
        repos.forEach(repo =>{
            ...
            <div class="card card-body mb-3 bg-dark">
                <div class="row">
                    <div class="col-md-6">
                        <a class="mb-6" style="color:white" href="${repo.html_url}" target="_blank">${repo.name}</a>
                    </div>
                    <div class="col-md-6">
